...
$query = "SELECT * FROM women_section";
...
if ($run_query->num_rows) {
    while ($row = $run_query->fetch_assoc()) {
        ...
        echo '<div class="container-img" style="background-image: url(./women_clothes/' . $img . ');"></div>
            <div class="details">
            ...
            <div class="button contentw">
                <div class="button-containerw">
                    <form action="women.php" method="post" class="add-to-cart-form">
